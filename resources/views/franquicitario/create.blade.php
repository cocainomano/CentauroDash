@extends("flowdash::layouts.{$layout}", [
  ...
  'breadcrumb' => [[
    ...
    'title' => 'Asignación de Franquicitarios'
  ]],
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Asignar Franquicitario a Franquicia</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('Franquicitarios.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
