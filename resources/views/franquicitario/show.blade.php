                ...
                <div class="card">
                    <div class="card-header">
                        <div class="float-left">
                            <span class="card-title">Detalle Franquicitario</span>
                        </div>
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('Franquicitarios.index') }}"> Regresar</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{ $franquicitario->sucursal->Nombre }}
                        </div>
                        <div class="form-group">
                            <strong>Franquicia:</strong>
                            {{ $franquicitario->franquicia->Nombre }}
                        </div>
                        <div class="form-group">
                            <strong>Nombre:</strong>
                            {{ $franquicitario->user->name }}
                        </div>
                        <div class="form-group">
                            <strong>Utilidad:</strong>
                            {{ $franquicitario->Utilidad }}%
                        </div>
                        <div class="form-group">
                            <strong>Created By:</strong>
                            {{ $franquicitario->Created_by }}
                        </div>
